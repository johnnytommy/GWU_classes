...
#%% [markdown]
import os
os.chdir('../Class07_Visualization')  
...
filepath = os.path.join( dirpath ,'gss_gwu_6103_2019f/GSS.csv')
...
try: print(gss.iat[rowind,colind])  # iat is for a single value only
except: print("iat[rowind,colind] error") 

try: print(gss.at[rowind,colname]) 
except: print("at[rowind,colname] error")  # similarly, at is for a single value
...
plt.ylabel('Rel freq.')
filepath = os.path.join( dirpath, 'hist_educ.png')
...
plt.show() 
filepath = os.path.join( dirpath, 'pmf_educ.png')
plt.savefig(filepath)
plt.show() 
...
filepath = os.path.join( dirpath, 'hist_educ_gender.png')
plt.savefig(filepath)
plt.show() 
...
filepath = os.path.join( dirpath, 'boxplot_age_degree.png')
# plt.savefig(filepath)
plt.show()
...
filepath = os.path.join( dirpath, 'violin_age_degree.png')
# plt.savefig(filepath)
plt.show()
...
filepath = os.path.join( dirpath ,'scatter_income_age.png')
plt.savefig(filepath)
plt.show()
