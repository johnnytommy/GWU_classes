...
# Question: Can you use something like this to calculate the stock's delta1 (daily change) in the past hw?
...
# both list comp and generator objects can be iterated 
print(listGen)
